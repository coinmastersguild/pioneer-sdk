...
const test_service = async function (this: any) {
    ...
    try {
        ...
        for(let i = 0; i < blockchains.length; i++){
            ...
            if(!assetContext.priceUsd || assetContext.priceUsd === 0 || assetContext.priceUsd.valueOf() === 0) {
              log.error(tag,"assetContext: ",assetContext)
              throw Error('Missing value for asset context')
            }
